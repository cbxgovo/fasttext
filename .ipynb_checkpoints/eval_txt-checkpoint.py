...
class NewsClassifier:
    def __init__(self):
        ...
        # 替换为你的绝对路径
        self.vocab_path = '/workspace-voice-ai/suyw@xiaopeng.com/llm/data/quality_data/fasttext/v0/pt_save_path/vocab.pkl'
        self.save_path = '/workspace-voice-ai/suyw@xiaopeng.com/llm/data/quality_data/fasttext/v0/pt_save_path/FastText.ckpt'
...
if __name__ == '__main__':
    ...
    output_file = '/workspace/xumh3@xiaopeng.com/text_quality/output/test_predictions.txt'
